    ...
    public class StringInput<TStructure> : IInput<TStructure, string>
    {
        ...
        ) => builder =>
        {
            ...
            (
                ...
                "Integrant.Rudiments.Input." + nameof(StringInput<TStructure>)
            );

            if (TextArea) classes.Add("Integrant.Rudiments.Input:TextArea");
            if (Monospace) classes.Add("Integrant.Rudiments.Input:Monospace");
